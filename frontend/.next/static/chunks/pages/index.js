        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              _context.next = 3;
              return fetch("http://localhost:3000/tools/".concat(tool.id), {
                method: 'DELETE'
              });
